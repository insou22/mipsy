        ...
        <nav class="flex bg-red-100 items-center justify-between flex-wrap bg-teal-500 p-6">
          ...
          <div class="w-full block flex-grow flex items-center w-auto">
            <div class="flex-grow flex flex-row">
              ...
              <button onclick=&self.props.reset_onclick class="flex flex-row mr-2 place-items-center inline-block cursor-pointer text-sm px-2 py-2 border rounded text-black border-black hover:border-transparent hover:text-teal-500 hover:bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <button class="flex flex-row place-items-center inline-block cursor-pointer text-sm px-2 py-2 border rounded-l text-black border-black hover:border-transparent hover:text-teal-500 hover:bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                </svg>
                {"Step Next"}
              </button>
              <button class="flex mr-2 flex-row place-items-center inline-block cursor-pointer text-sm px-2 py-2 border-t border-r border-b rounded-r text-black border-black hover:border-transparent hover:text-teal-500 hover:bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
