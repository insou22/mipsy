...
use colored::*;
use mipsy_lib::{decompile::decompile_inst_into_parts, decompile::Decompiled, Binary, InstSet};
use mipsy_lib::{decompile::Uninit, KTEXT_BOT};
...
pub(crate) fn print_inst_parts(
    binary: &Binary,
    parts: &Result<Decompiled, Uninit>,
